    ...
    <header class="header">
      ...
      <div class="swiper-box rgba">
        <swiper :options="swiperOption" ref="swiper" class="z-index_-1">
          <swiper-slide v-for="(poster,index) in slides" :key="index" style="width:100%;height:450px;background: url(http://qnimage.xiteng.com/z2.jpg) center center no-repeat;background-size: auto 100%; ">
            <div>{{slides.src}}</div>
          </swiper-slide>
        </swiper>
    ...
    data(){
      return{
        ...
        intro:[
          {
            title:'我们的业务',
            content:'桶装水的出现改变了人们长久以来的饮水习惯。日前我国主要饮水类型为自来水、桶装水、分质供水和自动售水机售水。'
          },
          {
            title:'您不知道的“桶装水”',
        ...
        items:[
          {
            src:"./static/images/v1_item1.png",
            title:"罗氏",
            content:"实验室质量管理、诊断之窗、罗氏调研"
          },
          {
            src:"./static/images/v1_item2.png",
            title:"罗氏",
            content:"实验室质量管理、诊断之窗、罗氏调研"
          },
          {
            src:"./static/images/v1_item3.png",
            title:"罗氏",
            content:"实验室质量管理、诊断之窗、罗氏调研"
          },
          {
            src:"./static/images/v2_item1.png",
            title:"罗氏",
            content:"实验室质量管理、诊断之窗、罗氏调研"
          },
          {
            src:"./static/images/v2_item2.png",
            title:"罗氏",
            content:"实验室质量管理、诊断之窗、罗氏调研"
          },
          {
            src:"./static/images/v2_item3.png",
            title:"罗氏",
            content:"实验室质量管理、诊断之窗、罗氏调研"
          },
        ]
